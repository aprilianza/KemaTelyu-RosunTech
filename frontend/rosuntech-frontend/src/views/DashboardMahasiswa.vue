<template>
  <div class="container mt-5">
    ...
    <h4>Events</h4>
    <div class="row">
      <div class="col-12 col-md-6 mb-3" v-for="event in events" :key="event.id">
        <div class="card">
          <img :src="event.image" class="card-img-top" alt="Event Image" />
          <div class="card-body">
            <h5 class="card-title">{{ event.title }}</h5>
            <button class="btn btn-info" @click="openModal(event)">See Details</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Modal -->
    <div v-if="selectedEvent" class="modal fade show" style="display: block;" tabindex="-1" role="dialog">
      ...
      events: [
        {
          ...
          description: 'Pembahasan teknologi terbaru di bidang AI dan Machine Learning.',
          date: '2025-06-15',
        ...
        },
        {
          ...
          image: 'https://via.placeholder.com/400x200 ',
          description: 'Pelatihan mendesain antarmuka pengguna yang responsif dan menarik.',
          date: '2025-07-01',
